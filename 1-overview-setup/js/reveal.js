	...
	function createBackgrounds() {
		...
		toArray( dom.wrapper.querySelectorAll( HORIZONTAL_SLIDES_SELECTOR ) ).forEach( function( slideh ) {
			...
			toArray( slideh.querySelectorAll( 'section' ) ).forEach( function( slidev ) {
				...
				// Check if slidev has "lonely-bg" class, since we want to not filter lone bg images
				let lonelyCheck = slidev.classList.contains('lonely-bg');
				// if true, add no filter class
				if (lonelyCheck == true) {
					slidev.classList.add('no-bg-filter');
				}
				
				// Check if slidev has "apply-darker-bg-filter" class, since we want to not filter lone bg images
				let darkBgCheck = slidev.classList.contains('apply-dark-bg-filter');
				// if true, add darker bg class
				if (darkBgCheck == true) {
					slidev.classList.add('dark-bg-filter');
				}

				// Check if slidev has "apply-darker-bg-filter" class, since we want to not filter lone bg images
				let darkerBgCheck = slidev.classList.contains('apply-darker-bg-filter');
				// if true, add darker bg class
				if (darkerBgCheck == true) {
					slidev.classList.add('slide-background-content');
				}

				// Check if slidev has "contain-me" class, since we want to not filter lone bg images
				let containMeCheck = slidev.classList.contains('contain-me');
				// if true, add no filter class
				if (containMeCheck == true) {
					slidev.classList.add('bg-contain-me');
				}

				// Check if slidev has "hamburglar" class
				let hamCheck = slidev.classList.contains('hamburglar');
				// if true, add no filter class
				if (hamCheck == true) {
					slidev.classList.add('hamburglar-filter');
				}

				// Check if slidev has "hamburglar" class
				let sheHulkCheck = slidev.classList.contains('she-hulk');
				// if true, add no filter class
				if (sheHulkCheck == true) {
					slidev.classList.add('she-hulk-filter');
				}

				let princessCheck = slidev.classList.contains('princess-bride');
				// if true, add no filter class
				if (princessCheck == true) {
					slidev.classList.add('princess-bride-filter');
				}
